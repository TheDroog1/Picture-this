...
struct keyFactsItem1 : Identifiable{
...
class keyFactsItemViewModel1 {
    
    var keyFactsItems = [
        keyFactsItem(leftText: "Toxicity", rightText: "Non toxic to humans and pets"),
        keyFactsItem(leftText: "Weed or not", rightText: "Not reported as a weed"),
        keyFactsItem(leftText: "Invasiveness", rightText: "Not invasive in Italy but it is in Canada"),
        keyFactsItem(leftText: "Plant Type", rightText: "Herb"),
        keyFactsItem(leftText: "Lifespan", rightText: "Annual"),
        keyFactsItem(leftText: "Planting TIme", rightText: "Late spring, Summer, Early fall, Mid fall")
    ]
}

struct keyFactsView1: View {
    
    var keyFactsviewModel = keyFactsItemViewModel1()
...
struct characteristicsItem1 : Identifiable{
...
class characteristicsItemViewModel1 {
    
    var characteristicsItems = [
        characteristicsItem(leftText: "Plant Height", rightText: "1 to 3 m"),
        characteristicsItem(leftText: "Spread", rightText: "30 to 100 cm"),
        characteristicsItem(leftText: "Leaf Color", rightText: "yellow"),
    ]
}

struct characteristicsView1: View {
    
    var characteristicsviewModel = characteristicsItemViewModel1()
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                if let plantName = plantName {
                    Text("\(plantName.capitalized), a species of Sunflowers (Helianthus)")
                        .font(.title)
...
struct PlantDistributionMapView1: View {
...
struct PlantAnnotation1: Identifiable {
    let id = UUID()
    let coordinate: CLLocationCoordinate2D
    let title: String?
    let color: Color
}
struct AnnotationView1: View {
